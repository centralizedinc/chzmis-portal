<template>
          <div align="middle"> 
              ...
              <a-select v-model="form.category" labelInValue :defaultValue="{ key: '0' }" style="width: 120px" @change="handleChange" >
...
export default {
  props: ['form'],
    ...
    second(){
      this.$store.commit("SET_REGISTRATION", this.category.label);
